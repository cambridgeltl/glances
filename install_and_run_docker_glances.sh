...
gpu_test=$(lspci |grep -i nvidia)
gpu_str="NVIDIA"
if [[ $gpu_test =~ $gpu_str ]] ; then
  ...
  echo "=====================No NVIDIA GPU CAN BE FOUND============================"
  wget https://raw.githubusercontent.com/cambridgeltl/glances/develop/glances-docker-cpu.service -O /etc/systemd/system/glances-docker.service
fi
